...
private:
	...
	RenderObject *obj_constant_work,     // pointer to active working objects
				 *obj_flat_work,
				 *obj_gouraud_work;

	RenderObject *obj_constant_array[NUM_OBJECTS], // array of objects
				 *obj_flat_array[NUM_OBJECTS],
				 *obj_gouraud_array[NUM_OBJECTS];

	int curr_constant_object,  // the current object of each class
		curr_flat_object,
		curr_gouraud_object;
