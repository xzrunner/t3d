...
// 	Build_Sin_Cos_Tables();
	...
	char *object_filenames[NUM_OBJECTS] = { "../../assets/chap11/cube_flat_01.cob",
											"../../assets/chap11/cube_gouraud_01.cob",
											"../../assets/chap11/cube_flat_textured_01.cob",
											"../../assets/chap11/sphere02.cob",
											"../../assets/chap11/sphere03.cob",
										  };
	...
	obj_scene->LoadCOB("../../assets/chap11/cube_gouraud_01.cob",  
					   &vscale, &vpos, &vrot, 
					   VERTEX_FLAGS_SWAP_YZ  |
					   VERTEX_FLAGS_TRANSFORM_LOCAL 
					   /* VERTEX_FLAGS_TRANSFORM_LOCAL_WORLD*/ );
...
void Game::Step()
{
	...
	graphics.FillSurface(graphics.GetBackSurface(), 0);
 	...
 	// draw the ground
 	DrawRectangle(0,WINDOW_HEIGHT*.5, WINDOW_WIDTH, WINDOW_HEIGHT, graphics.GetColor(190,190,230), graphics.GetBackSurface());
