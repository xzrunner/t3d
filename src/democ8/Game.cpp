...
// 	Build_Sin_Cos_Tables();
	...
	obj_terrain->GenerateTerrain(
		...
		"../../assets/chap12/checkerheight03.bmp",  // filename of height bitmap encoded in 256 colors
...
void Game::Step()
{
	...
	if (wireframe_mode) {
		...
		_list->DrawHybridTexturedSolidINVZB32(
	...
	if (help_mode)
	{
		...
		graphics.DrawTextGDI("<1>,<2>..........Decrease/Increase Z-Distance 1.", 0, text_y+=12, RGB(255,255,255), graphics.GetBackSurface());
		graphics.DrawTextGDI("<3>,<4>..........Decrease/Increase Z-Distance 2.", 0, text_y+=12, RGB(255,255,255), graphics.GetBackSurface());
