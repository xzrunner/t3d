...
int Parser::ReplaceChars(char *string_in, char *string_out, char *replace_chars, char rep_char, int case_on)
{
...
int Parser::StripChars(char *string_in, char *string_out, char *strip_chars, int case_on)
{
...
float Parser::IsFloat(char *fstring)
{
...
int Parser::SetComment(char *string)
{
	// sets the comment string
...
int Parser::Pattern_Match(char *string, char *pattern, ...)
{
...
// END IMPLEMENTATION OF Parser CLASS ///////////////////////////////////
}