...
// 	Build_Sin_Cos_Tables();
	...
	_obj_tank.LoadPLG("../../assets/chap08/tank2.plg", &vscale, &vpos, &vrot);

	// load player object for 3rd person view
	_obj_player.LoadPLG("../../assets/chap08/tank3.plg", &vscale, &vpos, &vrot);
