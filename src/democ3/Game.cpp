...
// 	Build_Sin_Cos_Tables();
	...
	char *object_filenames[NUM_OBJECTS] = { "../../assets/chap12/sphere_bw01.cob",
											"../../assets/chap12/sphere_red_alpha01.cob",  
											"../../assets/chap12/sphere_green_alpha01.cob",
											"../../assets/chap12/sphere_blue_alpha01.cob",
											"../../assets/chap12/sphere_white_alpha01.cob",
	};

	// load in default object
	vec4 vscale(50.00,50.00,50.00,1),
		 vpos(0,0,150,1), 
		 vrot(0,0,0,1);
...
// 		rgblookup);          // lookup table
	...
	BmpFile* bitmap = new BmpFile("../../assets/chap12/checkerboard800.bmp");
