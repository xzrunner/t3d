...
private:
	...
	// terrain defines
	static const int TERRAIN_WIDTH		= 2000;
	static const int TERRAIN_HEIGHT		= 2000;
	static const int TERRAIN_SCALE		= 700;

	static const int NUM_OBJECTS = 7;			// number of objects system loads
	static const int NUM_SCENE_OBJECTS = 25;   // number of scenery objects
	static const int UNIVERSE_RADIUS = 1750;    // size of universe
	static const int MAX_VEL = 10;				// maxium velocity of objects
