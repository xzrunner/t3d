...
// 	Build_Sin_Cos_Tables();
	...
	_cam = new Camera(CAM_MODEL_EULER,		// the euler model
					  vec4(0,500,-300,1),	// initial camera position
	...
	obj_terrain->GenerateTerrain(TERRAIN_WIDTH,				// width in world coords on x-axis
								...
								"../../assets/chap14/grass256_256_02.bmp",   // filename of texture map
...
//	graphics.FillSurface(graphics.GetBackSurface(), 0);
	...
	obj_work->SetWorldPos(200*cos(DEG_TO_RAD(obj_work->GetIVar1())),
						  200+50*sin(DEG_TO_RAD(3*obj_work->GetIVar1())),
						  200*sin(DEG_TO_RAD(obj_work->GetIVar1())));
